...
// Testbench that measure PWM duty cycle for each input value and writes CSV
...
module tb_pwm_measure;
    ...
    initial begin
        ...
        integer v;
        integer cycles = 1024; * (1 << WIDTH); // ensure many PWM peridos
        value = v;
        ...
        $display("value=0%d measured_frac%f", v, frac);
    end
    $fclose(csv);
    $finish;
    end
